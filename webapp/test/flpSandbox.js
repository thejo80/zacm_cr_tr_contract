		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ACM: Excel Upload",
									"targetURL": "#acmtrconexcelzacmexcelupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"acmtrconexcelzacmexcelupload-display": {
								"semanticObject": "acmtrconexcelzacmexcelupload",
								"action": "display",
								"description": "ACM Trading Contract Excel Upload",
								"title": "ACM: Excel Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=acm.trcon.excel.zacmexcelupload1",
									"url": sap.ui.require.toUrl("acm/trcon/excel/zacmexcelupload1")
								}
							}
						}
					}
